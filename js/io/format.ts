...
// ============================================
// Generic 3D Format - General Purpose 3D Modeling
// ============================================
new ModelFormat('generic_3d', {
	id: 'generic_3d',
	name: 'Generic 3D Model',
	icon: 'fa-cube',
	description: 'General purpose 3D modeling format with support for primitives (spheres, cylinders, cones, etc.)',
	category: 'general',
	target: 'Both',
